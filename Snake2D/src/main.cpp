...
void init()
{
    ...
    std::size_t basePos{ exePath.find("build") };
    std::string basePath{ exePath.substr(0, basePos) };
    Snake2D::g_imgDirPath = basePath + "Snake2D/" + SNAKE2D_IMG_FOLDER;
    Snake2D::g_fontsDirPath = basePath + "Snake2D/" + SNAKE2D_FONTS_FOLDER;
